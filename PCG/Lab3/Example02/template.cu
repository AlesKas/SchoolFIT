 ...
 *
 * @brief     PC lab 3 / Texture memory with data in CUDA array
 *
...
bool runTest(int argc, char** argv)
{
  ...
  //------------------------------------------------------------------------------------------------------------------//
  // 2. Create Channel Format (cudaCreateChannelDesc)
  ...
  //------------------------------------------------------------------------------------------------------------------//
  // 3. Allocate memory for the texture using CUDA Array and copy the image on GPU                                    //
  //    Use cudaMallocArray and cudaMemcpy2DToArray                                                                   //
