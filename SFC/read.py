...
class Ui_Form(QWidget):
    def setupUi(self, Form):
        ...
        self.horizontalLayout_2.addWidget(self.input_4)
        ...
        self.horizontalLayout_2.addWidget(self.input_5)
        ...
        self.horizontalLayout_2.addWidget(self.input_6)
        ...
        self.horizontalLayout_2.addWidget(self.input_7)
        ...
        self.horizontalLayout_2.addWidget(self.input_8)
        ...
        self.verticalLayout_2.addWidget(self.radius)
        ...
        self.horizontalLayout.addWidget(self.odezva_1)
        ...
        self.horizontalLayout.addWidget(self.odezva_2)
        ...
        self.horizontalLayout.addWidget(self.odezva_3)
        ...
        self.horizontalLayout.addWidget(self.odezva_4)
        ...
        self.horizontalLayout.addWidget(self.odezva_5)
        ...
        self.horizontalLayout.addWidget(self.odezva_6)
        ...
        self.horizontalLayout.addWidget(self.odezva_7)
        ...
        self.horizontalLayout.addWidget(self.odezva_8)
        ...
        self.prah_1 = QLineEdit(Form)
        self.prah_1.setObjectName(u"prah_1")
        self.prah_1.setMaxLength(5)
        self.prah_1.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_27.addWidget(self.prah_1)

        self.prah_2 = QLineEdit(Form)
        self.prah_2.setObjectName(u"prah_2")
        self.prah_2.setMaxLength(5)
        self.prah_2.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_27.addWidget(self.prah_2)

        self.prah_3 = QLineEdit(Form)
        self.prah_3.setObjectName(u"prah_3")
        self.prah_3.setMaxLength(5)
        self.prah_3.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_27.addWidget(self.prah_3)

        self.prah_4 = QLineEdit(Form)
        self.prah_4.setObjectName(u"prah_4")
        self.prah_4.setMaxLength(5)
        self.prah_4.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_27.addWidget(self.prah_4)

        self.prah_5 = QLineEdit(Form)
        self.prah_5.setObjectName(u"prah_5")
        self.prah_5.setMaxLength(5)
        self.prah_5.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_27.addWidget(self.prah_5)

        self.prah_6 = QLineEdit(Form)
        self.prah_6.setObjectName(u"prah_6")
        self.prah_6.setMaxLength(5)
        self.prah_6.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_27.addWidget(self.prah_6)

        self.prah_7 = QLineEdit(Form)
        self.prah_7.setObjectName(u"prah_7")
        self.prah_7.setMaxLength(5)
        self.prah_7.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_27.addWidget(self.prah_7)

        self.prah_8 = QLineEdit(Form)
        self.prah_8.setObjectName(u"prah_8")
        self.prah_8.setMaxLength(5)
        self.prah_8.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_27.addWidget(self.prah_8)
        ...
        self.soucet_1 = QLineEdit(Form)
        self.soucet_1.setObjectName(u"soucet_1")
        self.soucet_1.setMaxLength(5)
        self.soucet_1.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_28.addWidget(self.soucet_1)

        self.soucet_2 = QLineEdit(Form)
        self.soucet_2.setObjectName(u"soucet_2")
        self.soucet_2.setMaxLength(5)
        self.soucet_2.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_28.addWidget(self.soucet_2)

        self.soucet_3 = QLineEdit(Form)
        self.soucet_3.setObjectName(u"soucet_3")
        self.soucet_3.setMaxLength(5)
        self.soucet_3.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_28.addWidget(self.soucet_3)

        self.soucet_4 = QLineEdit(Form)
        self.soucet_4.setObjectName(u"soucet_4")
        self.soucet_4.setMaxLength(5)
        self.soucet_4.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_28.addWidget(self.soucet_4)

        self.soucet_5 = QLineEdit(Form)
        self.soucet_5.setObjectName(u"soucet_5")
        self.soucet_5.setMaxLength(5)
        self.soucet_5.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_28.addWidget(self.soucet_5)

        self.soucet_6 = QLineEdit(Form)
        self.soucet_6.setObjectName(u"soucet_6")
        self.soucet_6.setMaxLength(5)
        self.soucet_6.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_28.addWidget(self.soucet_6)

        self.soucet_7 = QLineEdit(Form)
        self.soucet_7.setObjectName(u"soucet_7")
        self.soucet_7.setMaxLength(5)
        self.soucet_7.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_28.addWidget(self.soucet_7)

        self.soucet_8 = QLineEdit(Form)
        self.soucet_8.setObjectName(u"soucet_8")
        self.soucet_8.setMaxLength(5)
        self.soucet_8.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_28.addWidget(self.soucet_8)
        ...
        self.horizontalLayout_6.addWidget(self.addres_1_1)
        ...
        self.horizontalLayout_6.addWidget(self.addres_1_2)
        ...
        self.horizontalLayout_6.addWidget(self.addres_1_3)
        ...
        self.horizontalLayout_6.addWidget(self.addres_1_4)
        ...
        self.horizontalLayout_6.addWidget(self.addres_1_5)
        ...
        self.horizontalLayout_6.addWidget(self.addres_1_6)
        ...
        self.horizontalLayout_6.addWidget(self.addres_1_7)
        ...
        self.horizontalLayout_6.addWidget(self.addres_1_8)
        ...
        self.horizontalLayout_7.addWidget(self.addres_1_9)
        ...
        self.horizontalLayout_7.addWidget(self.addres_1_10)
        ...
        self.horizontalLayout_7.addWidget(self.addres_1_11)
        ...
        self.horizontalLayout_7.addWidget(self.addres_1_12)
        ...
        self.horizontalLayout_7.addWidget(self.addres_1_13)
        ...
        self.horizontalLayout_7.addWidget(self.addres_1_14)
        ...
        self.horizontalLayout_7.addWidget(self.addres_1_15)
        ...
        self.horizontalLayout_7.addWidget(self.addres_1_16)
        ...
        self.horizontalLayout_8.addWidget(self.addres_1_17)
        ...
        self.horizontalLayout_8.addWidget(self.addres_1_18)
        ...
        self.horizontalLayout_8.addWidget(self.addres_1_19)
        ...
        self.horizontalLayout_8.addWidget(self.addres_1_20)
        ...
        self.horizontalLayout_8.addWidget(self.addres_1_21)
        ...
        self.horizontalLayout_8.addWidget(self.addres_1_22)
        ...
        self.horizontalLayout_8.addWidget(self.addres_1_23)
        ...
        self.horizontalLayout_8.addWidget(self.addres_1_24)
        ...
        self.horizontalLayout_9.addWidget(self.addres_1_25)
        ...
        self.horizontalLayout_9.addWidget(self.addres_1_26)
        ...
        self.horizontalLayout_9.addWidget(self.addres_1_27)
        ...
        self.horizontalLayout_9.addWidget(self.addres_1_28)
        ...
        self.horizontalLayout_9.addWidget(self.addres_1_29)
        ...
        self.horizontalLayout_9.addWidget(self.addres_1_30)
        ...
        self.horizontalLayout_9.addWidget(self.addres_1_31)
        ...
        self.horizontalLayout_9.addWidget(self.addres_1_32)
        ...
        self.horizontalLayout_10.addWidget(self.addres_1_33)
        ...
        self.horizontalLayout_10.addWidget(self.addres_1_34)
        ...
        self.horizontalLayout_10.addWidget(self.addres_1_35)
        ...
        self.horizontalLayout_10.addWidget(self.addres_1_36)
        ...
        self.horizontalLayout_10.addWidget(self.addres_1_37)
        ...
        self.horizontalLayout_10.addWidget(self.addres_1_38)
        ...
        self.horizontalLayout_10.addWidget(self.addres_1_39)
        ...
        self.horizontalLayout_10.addWidget(self.addres_1_40)
        ...
        self.horizontalLayout_11.addWidget(self.addres_1_41)
        ...
        self.horizontalLayout_11.addWidget(self.addres_1_42)
        ...
        self.horizontalLayout_11.addWidget(self.addres_1_43)
        ...
        self.horizontalLayout_11.addWidget(self.addres_1_44)
        ...
        self.horizontalLayout_11.addWidget(self.addres_1_45)
        ...
        self.horizontalLayout_11.addWidget(self.addres_1_46)
        ...
        self.horizontalLayout_11.addWidget(self.addres_1_47)
        ...
        self.horizontalLayout_11.addWidget(self.addres_1_48)
        ...
        self.horizontalLayout_12.addWidget(self.addres_1_49)
        ...
        self.horizontalLayout_12.addWidget(self.addres_1_50)
        ...
        self.horizontalLayout_12.addWidget(self.addres_1_51)
        ...
        self.horizontalLayout_12.addWidget(self.addres_1_52)
        ...
        self.horizontalLayout_12.addWidget(self.addres_1_53)
        ...
        self.horizontalLayout_12.addWidget(self.addres_1_54)
        ...
        self.horizontalLayout_12.addWidget(self.addres_1_55)
        ...
        self.horizontalLayout_12.addWidget(self.addres_1_56)
        ...
        self.horizontalLayout_13.addWidget(self.addres_1_57)
        ...
        self.horizontalLayout_13.addWidget(self.addres_1_58)
        ...
        self.horizontalLayout_13.addWidget(self.addres_1_59)
        ...
        self.horizontalLayout_13.addWidget(self.addres_1_60)
        ...
        self.horizontalLayout_13.addWidget(self.addres_1_61)
        ...
        self.horizontalLayout_13.addWidget(self.addres_1_62)
        ...
        self.horizontalLayout_13.addWidget(self.addres_1_63)
        ...
        self.horizontalLayout_13.addWidget(self.addres_1_64)
        ...
        self.horizontalLayout_14.addWidget(self.addres_1_65)
        ...
        self.horizontalLayout_14.addWidget(self.addres_1_66)
        ...
        self.horizontalLayout_14.addWidget(self.addres_1_67)
        ...
        self.horizontalLayout_14.addWidget(self.addres_1_68)
        ...
        self.horizontalLayout_14.addWidget(self.addres_1_69)
        ...
        self.horizontalLayout_14.addWidget(self.addres_1_70)
        ...
        self.horizontalLayout_14.addWidget(self.addres_1_71)
        ...
        self.horizontalLayout_14.addWidget(self.addres_1_72)
        ...
        self.horizontalLayout_15.addWidget(self.addres_1_73)
        ...
        self.horizontalLayout_15.addWidget(self.addres_1_74)
        ...
        self.horizontalLayout_15.addWidget(self.addres_1_75)
        ...
        self.horizontalLayout_15.addWidget(self.addres_1_76)
        ...
        self.horizontalLayout_15.addWidget(self.addres_1_77)
        ...
        self.horizontalLayout_15.addWidget(self.addres_1_78)
        ...
        self.horizontalLayout_15.addWidget(self.addres_1_79)
        ...
        self.horizontalLayout_15.addWidget(self.addres_1_80)
        ...
        self.horizontalLayout_16.addWidget(self.counter_1)
        ...
        self.horizontalLayout_16.addWidget(self.counter_2)
        ...
        self.horizontalLayout_16.addWidget(self.counter_3)
        ...
        self.horizontalLayout_16.addWidget(self.counter_4)
        ...
        self.horizontalLayout_16.addWidget(self.counter_5)
        ...
        self.horizontalLayout_16.addWidget(self.counter_6)
        ...
        self.horizontalLayout_16.addWidget(self.counter_7)
        ...
        self.horizontalLayout_16.addWidget(self.counter_8)
        ...
        self.horizontalLayout_17.addWidget(self.counter_9)
        ...
        self.horizontalLayout_17.addWidget(self.counter_10)
        ...
        self.horizontalLayout_17.addWidget(self.counter_11)
        ...
        self.horizontalLayout_17.addWidget(self.counter_12)
        ...
        self.horizontalLayout_17.addWidget(self.counter_13)
        ...
        self.horizontalLayout_17.addWidget(self.counter_14)
        ...
        self.horizontalLayout_17.addWidget(self.counter_15)
        ...
        self.horizontalLayout_17.addWidget(self.counter_16)
        ...
        self.horizontalLayout_18.addWidget(self.counter_17)
        ...
        self.horizontalLayout_18.addWidget(self.counter_18)
        ...
        self.horizontalLayout_18.addWidget(self.counter_19)
        ...
        self.horizontalLayout_18.addWidget(self.counter_20)
        ...
        self.horizontalLayout_18.addWidget(self.counter_21)
        ...
        self.horizontalLayout_18.addWidget(self.counter_22)
        ...
        self.horizontalLayout_18.addWidget(self.counter_23)
        ...
        self.horizontalLayout_18.addWidget(self.counter_24)
        ...
        self.horizontalLayout_19.addWidget(self.counter_25)
        ...
        self.horizontalLayout_19.addWidget(self.counter_26)
        ...
        self.horizontalLayout_19.addWidget(self.counter_27)
        ...
        self.horizontalLayout_19.addWidget(self.counter_28)
        ...
        self.horizontalLayout_19.addWidget(self.counter_29)
        ...
        self.horizontalLayout_19.addWidget(self.counter_30)
        ...
        self.horizontalLayout_19.addWidget(self.counter_31)
        ...
        self.horizontalLayout_19.addWidget(self.counter_32)
        ...
        self.horizontalLayout_20.addWidget(self.counter_33)
        ...
        self.horizontalLayout_20.addWidget(self.counter_34)
        ...
        self.horizontalLayout_20.addWidget(self.counter_35)
        ...
        self.horizontalLayout_20.addWidget(self.counter_36)
        ...
        self.horizontalLayout_20.addWidget(self.counter_37)
        ...
        self.horizontalLayout_20.addWidget(self.counter_38)
        ...
        self.horizontalLayout_20.addWidget(self.counter_39)
        ...
        self.horizontalLayout_20.addWidget(self.counter_40)
        ...
        self.horizontalLayout_21.addWidget(self.counter_41)
        ...
        self.horizontalLayout_21.addWidget(self.counter_42)
        ...
        self.horizontalLayout_21.addWidget(self.counter_43)
        ...
        self.horizontalLayout_21.addWidget(self.counter_44)
        ...
        self.horizontalLayout_21.addWidget(self.counter_45)
        ...
        self.horizontalLayout_21.addWidget(self.counter_46)
        ...
        self.horizontalLayout_21.addWidget(self.counter_47)
        ...
        self.horizontalLayout_21.addWidget(self.counter_48)
        ...
        self.horizontalLayout_22.addWidget(self.counter_49)
        ...
        self.horizontalLayout_22.addWidget(self.counter_50)
        ...
        self.horizontalLayout_22.addWidget(self.counter_51)
        ...
        self.horizontalLayout_22.addWidget(self.counter_52)
        ...
        self.horizontalLayout_22.addWidget(self.counter_53)
        ...
        self.horizontalLayout_22.addWidget(self.counter_54)
        ...
        self.horizontalLayout_22.addWidget(self.counter_55)
        ...
        self.horizontalLayout_22.addWidget(self.counter_56)
        ...
        self.horizontalLayout_23.addWidget(self.counter_57)
        ...
        self.horizontalLayout_23.addWidget(self.counter_58)
        ...
        self.horizontalLayout_23.addWidget(self.counter_59)
        ...
        self.horizontalLayout_23.addWidget(self.counter_60)
        ...
        self.horizontalLayout_23.addWidget(self.counter_61)
        ...
        self.horizontalLayout_23.addWidget(self.counter_62)
        ...
        self.horizontalLayout_23.addWidget(self.counter_63)
        ...
        self.horizontalLayout_23.addWidget(self.counter_64)
        ...
        self.horizontalLayout_24.addWidget(self.counter_65)
        ...
        self.horizontalLayout_24.addWidget(self.counter_66)
        ...
        self.horizontalLayout_24.addWidget(self.counter_67)
        ...
        self.horizontalLayout_24.addWidget(self.counter_68)
        ...
        self.horizontalLayout_24.addWidget(self.counter_69)
        ...
        self.horizontalLayout_24.addWidget(self.counter_70)
        ...
        self.horizontalLayout_24.addWidget(self.counter_71)
        ...
        self.horizontalLayout_24.addWidget(self.counter_72)
        ...
        self.horizontalLayout_25.addWidget(self.counter_73)
        ...
        self.horizontalLayout_25.addWidget(self.counter_74)
        ...
        self.horizontalLayout_25.addWidget(self.counter_75)
        ...
        self.horizontalLayout_25.addWidget(self.counter_76)
        ...
        self.horizontalLayout_25.addWidget(self.counter_77)
        ...
        self.horizontalLayout_25.addWidget(self.counter_78)
        ...
        self.horizontalLayout_25.addWidget(self.counter_79)
        ...
        self.horizontalLayout_25.addWidget(self.counter_80)
        ...
        self.horizontalLayout_4.addWidget(self.step_button)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(QCoreApplication.translate("Form", u"Odezva", None))
        self.label_9.setText(QCoreApplication.translate("Form", u"Pr\u00e1h     ", None))
        self.label_8.setText(QCoreApplication.translate("Form", u"Sou\u010det ", None))
    ...
    def step(self):
        ...
        if self.states[self.state] == 'init':
            ...
            for idx in range(1, 9):
                self.findChild(QLineEdit, thresholdName + str(idx)).setText('0')
                self.findChild(QLineEdit, sumName + str(idx)).setText('0')
                self.findChild(QLineEdit, outputName + str(idx)).setText('0')
            self.state += 1
            return
        ...
        if self.states[self.state] == 'select':
            ...
            for iter in range(1, 11):
                ...
                if int(distance) <= 2:
                    self.selcted_weights.append(iter - 1)
        ...
        if self.states[self.state] == 'select_selected':
            ...
            self.state += 1
            return
        if self.states[self.state] == 'calculate_sum':
            sumName = 'soucet_'
            for sumN in range(1, 9):
                self.findChild(QLineEdit, sumName + str(sumN)).setStyleSheet("QLineEdit {background : blue;}")
            sum_neurons = self.sdm.weights[self.selcted_weights].sum(axis=0)
            for sumN in range(1, len(sum_neurons) + 1):
                self.findChild(QLineEdit, sumName + str(sumN)).setText(str(sum_neurons[sumN - 1]))
            self.state += 1
            return
        if self.states[self.state] == 'calculate_threshold':
            ...
            threshold = self.sdm.weights.sum(axis=0)
            threshold = threshold / 2
            threshold = threshold.astype(np.int16)
            for sumN in range(1, len(threshold) + 1):
                self.findChild(QLineEdit, thresholdName + str(sumN)).setText(str(threshold[sumN - 1]))
            self.state += 1
            return
        if self.states[self.state] == 'check_response':
            ...
            for idx in range(1, 9):
                if int(self.findChild(QLineEdit, sumName + str(sumN)).text()) > int(self.findChild(QLineEdit, thresholdName + str(idx)).text()):
                    self.findChild(QLineEdit, outputName + str(idx)).setText('1')
                else:
                    self.findChild(QLineEdit, outputName + str(idx)).setText('0')
            self.state += 1
            return
    ...
    def fill_counters(self):
        ...
        for iter1 in range(0, 10):
            for iter2 in range(0, 8):
                widget = widgetName + str((iter1 * 8 + iter2) + 1)
                self.findChild(QLineEdit, widget).setText(str(self.sdm.weights[iter1][iter2]))
    ...
    def init(self):
        if self.init_counter == 0:
            ...
            data = np.random.randint(low=0, high=2, size=(100, 8))
            for dato in data:
                self.sdm.write(dato)
            self.input_vector = np.random.randint(low=0, high=2, size=(1, 8))
            self.fill_input()
            self.fill_addresses()
    ...
    def init_buttons(self):
        self.states = ['init', 'distance', 'select', 'select_selected', 'calculate_sum', 'calculate_threshold', 'check_response', 'clear_colours']
        self.state = 1
        self.init_counter = 0
